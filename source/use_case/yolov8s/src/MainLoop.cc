...
#include "Yolov8sModel.hpp"         /* Model class for running inference. */
...
void MainLoop()
{
    arm::app::Yolov8sModel model;  /* Model wrapper object. */
    ...
    arm::app::Profiler profiler{ "yolov8s" };
    caseContext.Set<arm::app::Profiler&>("profiler", profiler);
    caseContext.Set<arm::app::Model&>("model", model);

    Yolov8sClassifier classifier;  /* Classifier wrapper object. */
