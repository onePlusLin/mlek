...
#include "../../../../dependencies/core-driver/src/ethosu_interface.h"
#include "../../../../dependencies/core-driver/src/ethosu_device.h"
#include "../../../../dependencies/core-driver/src/ethosu_log.h"
#include "../../../../dependencies/core-driver/src/ethosu_config_u65.h"
#include "../../../../dependencies/core-driver/include/ethosu_driver.h"
#include "ARMCM55.h"


#include <stdio.h>

#define ETHOSU_BASE        0x58102000
...
struct ethosu_device ethos_dev;
 ...
 ****************************************************************************/
// clang-format off
__attribute__((section(".ddr.at_ddr"), aligned(16))) char commandStream[] = {
    DRIVER_ACTION_MAGIC()
    DRIVER_ACTION_NOP()
    DRIVER_ACTION_NOP()
 ...
 __attribute__((section(".ddr.at_ddr"), aligned(16))) char tflmModel[] = {
 ...
 __attribute__((section(".ddr.at_ddr"), aligned(16))) char tflmArena[] = {
...
{
	unsigned int* reg_p;
	reg_p = (unsigned int*) address;
	return *reg_p;
}
										
struct ethosu_device *get_ethos_drv(void)
{
	return &ethos_dev;
}	
...
void arm_ethosu_npu_irq_handler(void)
{
    /* Call the default interrupt handler from the NPU driver */
	  //reg_status=read_reg(ETHOSU_BASE+0x4);
    ethosu_irq_handler(&ethosu_drv);
}

static void arm_ethosu_npu_irq_init(void)
{
    const IRQn_Type ethosu_irqnum = (IRQn_Type)56;//ETHOS_U_IRQN;
...
int conv_main(uint8_t* cache_addr, size_t cache_size){
    /*
    ...
    //printf("wayne start\n");
    //if (!ethosu_dev_init(&ethos_dev, (void*)ETHOSU_BASE, 0, 0))
    //{
    //    printf("Failed to initialize Ethos-U device");
    //    return -1;
    //}
    //printf("NPU ok.\n");
    ...
    void* const ethosu_base_address = (void *)(ETHOSU_BASE);
    printf("Initialising Ethos-U %x\n", (uint32_t)(ETHOSU_BASE));

    if (0 != (err = ethosu_init(&ethosu_drv,         /* Ethos-U driver device pointer */
                                ethosu_base_address, /* Ethos-U NPU's base address. */
                                cache_addr,   /* Pointer to fast mem area - NULL for U55. */
                                cache_size, /* Fast mem region size. */
                                1,    /* Security. */
                                0))) /* Privilege. */ {
