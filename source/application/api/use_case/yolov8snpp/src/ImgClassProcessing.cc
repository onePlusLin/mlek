...
namespace arm {
    namespace app {
        ...
        {
            info("DoPreProcess start in yolov8snpp.\n\n\n");
            if (data == nullptr) {
        ...
        {
            info("DoPostProcess start in yolov8snpp.\n\n\n");
            ...
            DetectionResultList det_results;
            ...
            if (success) {
                m_postProcessor.print_results(det_results, &m_labels);
            }
