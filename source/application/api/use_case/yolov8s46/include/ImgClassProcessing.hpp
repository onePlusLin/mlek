...
namespace arm {
    namespace app {
        ...
        class ImgClassPreProcess : public BasePreProcess {
             ...
             * @param[in]   convertToInt8   Should image be converted to Int8 range.
             **/
        ...
        class ImgClassPostProcess : public BasePostProcess {
            ...
            /**
             * @brief       Dump all detection results to JSON file
             * @return      true if successful, false otherwise.
             **/
            bool DumpAllResultsToJson();
            ...
            int m_image_id;
            std::vector<std::pair<int, std::vector<DetectionBox>>> m_all_detections;
        };
