...
list(APPEND ${use_case}_API_LIST "yolov8ssegnpp")
...
USER_OPTION(${use_case}_LABELS_TXT_FILE "Labels' txt file for the chosen model"
    ${CMAKE_CURRENT_SOURCE_DIR}/resources/${use_case}/labels/labels_yolov8ssegnpp.txt
    FILEPATH)
...
if (ETHOS_U_NPU_ENABLED)
    set(DEFAULT_MODEL_PATH      ${DEFAULT_MODEL_DIR}/yolov8ssegnpp_vela_${ETHOS_U_NPU_CONFIG_ID}.tflite)
else()
    set(DEFAULT_MODEL_PATH      ${DEFAULT_MODEL_DIR}/yolov8ssegnpp.tflite)
endif()
...
generate_tflite_code(
    ...
    NAMESPACE   "arm" "app" "yolov8ssegnpp")
